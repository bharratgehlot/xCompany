...
function ProfileCard5({sortBy}) {
  ...
  function likeIncrement() {
    ...
    localStorage.setItem('profile-card5-likes', newLikes)
  }
  ...
  const toggleSkills = () => {
   ...
   const toggleOnlineStatus = () => {
    ...
    localStorage.setItem('saved-status5', JSON.stringify(saveOnlineStatus))
  }
  ...
  return <div className={style.profilecard}>
    ...
    <h2>{profile.name}</h2>
    <img className={style.image} src={profile.image} alt="Bhawna Mittal" />
